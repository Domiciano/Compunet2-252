...
### 1. Instala Tailwind y sus dependencias
...
Edita el archivo para incluir todas las rutas donde usarás clases Tailwind:
...
### 3. Agrega las directivas de Tailwind a tu CSS

Crea (o edita) el archivo `src/index.css` con el siguiente contenido:
...
### 4. Importa el CSS en tu app React

En `main.jsx` o `main.tsx`:
...
Puedes probarlo agregando una clase de Tailwind en `App.jsx`:
...
¡Listo! Ya tienes Tailwind CSS funcionando en tu app de React.
